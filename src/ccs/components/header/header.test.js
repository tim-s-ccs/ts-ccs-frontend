...
describe('Header navigation', () => {
  ...
  describe('when JavaScript is unavailable or fails', () => {
    beforeAll(async () => {
      ...
      await page.goto(`${baseUrl}/components/header/with-both-navigation/preview`, {
        waitUntil: 'load'
      })
    })
  ...
  describe('when JavaScript is available', () => {
    ...
    describe('on page load', () => {
      ...
      it('exposes the collapsed state of the menu button using aria-expanded', async () => {
        const ariaExpanded = await page.$eval('.ccs-header__menu-button',
    ...
    describe('when menu button is pressed', () => {
      ...
      it('adds the --open modifier class to the menu, making it visible', async () => {
        const hasOpenClass = await page.$eval('.ccs-header__navigation-lists',
      ...
      it('adds the --open modifier class to the menu button', async () => {
        const hasOpenClass = await page.$eval('.ccs-header__menu-button',
