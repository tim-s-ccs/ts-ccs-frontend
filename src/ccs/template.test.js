...
describe('Template', () => {
  ...
  describe('<head>', () => {
    ...
    it('uses a default assets URL of whatever assetPath is', () => {
      ...
      expect($ogImage.attr('content')).toEqual('/whatever/images/ccs-opengraph-image.png')
    })
    ...
    it('can have the assets URL overridden using assetUrl', () => {
      ...
      expect($ogImage.attr('content')).toEqual('//a.gov.uk/images/ccs-opengraph-image.png')
    })
    ...
    describe('<title>', () => {
      const expectedTitle = 'Crown Commercial Service'
